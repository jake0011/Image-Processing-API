...
var Images = './images/full';
var storeImages = './images/thumb';
var imageProcessor = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
    var width, height, filename, thumbDir, imageDir;
    return __generator(this, function (_a) {
      width = req.query.width;
      height = req.query.height;
      filename = req.query.filename;
      thumbDir = path_1.default.join(
        __dirname,
        ''.concat(storeImages),
        ''.concat(filename, '_').concat(width, 'x').concat(height, '.jpg')
      );
      imageDir = path_1.default.join(
        __dirname,
        ''.concat(Images),
        ''.concat(filename, '.jpg')
      );
      try {
        if ((0, fs_1.existsSync)(thumbDir)) {
          res.sendFile(thumbDir);
        } else {
          (0, sharp_1.default)(imageDir)
        ...
        if (width <= 0 || height <= 0) {
          ...
          res.send('There is no image with the name: '.concat(filename));
        }
        next(error);
      }
      return [2 /*return*/];
